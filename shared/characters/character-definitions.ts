 ...
 * says what the signet does (e.g. "Fight! + 2 candy") instead of the generic
 * "Signet Trigger". Call when the character is selected.
 */
...
export const characterDefinitions: Record<CharacterEnum, CharacterDefinition> = {
    [CharacterEnum.ChillDudes]: {
        ...
        signetAbilityDescription: "+1 card + 1 loot",
    ...
    [CharacterEnum.StreetWizards]: {
        ...
        signetAbilityDescription: "+3 loot",
    ...
    [CharacterEnum.TechBros]: {
        ...
        signetAbilityDescription: "+2 cards + 1 candy",
        executeSignetAbility: (state, player) => {
