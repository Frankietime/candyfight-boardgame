...
const es: Messages = {
    ...
    lobby: {
        ...
        humanSeat: "Humano",
        botSeat: "Bot",
        openSeat: "Asiento libre — se une desde el lobby",
        addSeat: "Agregar asiento",
        mixedUnsupported: "Humanos + bots en la misma partida: próximamente",
        victoryPoints: "Puntos de victoria",
        noMatches: "Todavía no hay partidas abiertas",
    },
    menu: {
        title: "Menú",
        rules: "Reglas",
    ...
    decklab: {
        title: "Mazos",
        newDeckSet: "+ Nuevo Mazo",
        empty: "Todavía no hay mazos guardados — creá el primero",
        unavailable: "Sin base de datos configurada (DATABASE_URL) — los mazos no se pueden guardar",
    },
    signetlab: {
        title: "Personajes",
        newSignetSet: "+ Nuevo Set de Personajes",
        empty: "Todavía no hay sets de personajes guardados — creá el primero",
        unavailable: "Sin base de datos configurada (DATABASE_URL) — los personajes no se pueden guardar",
    },
    modlab: {
        title: "Mod Lab",
        newMod: "+ Nuevo Mod",
        empty: "Todavía no hay mods — creá el primero",
        unavailable: "Sin base de datos configurada (DATABASE_URL) — los mods no se pueden guardar",
        edit: "Editar",
        duplicate: "Duplicar",
        delete: "Borrar",
        confirmDelete: "¿Borrar este mod para siempre?",
        back: "Volver",
        save: "Guardar",
        unsaved: "SIN GUARDAR",
        saved: "Guardado",
        ...
        updated: "Actualizado",
        loadDialogTitle: "Cargar cartucho",
        baseCartridge: "Base (incluido)",
        loaded: "CARGADO",
        load: "Cargar",
        locationName: "Nombre de la location",
        restrictedArea: "Área restringida",
        restrictedAreaUnsupported: "Todavía no soportado en mods",
        notSupportedYet: "próximamente",
        disabledLocation: "Deshabilitada (tachada en rojo)",
        viewBoard: "Tablero",
        viewDecks: "Mazos",
        viewCharacters: "Personajes",
        baseDeck: "Mazo base",
        baseDeckHint: "El mazo inicial de cada jugador (+ su carta Signet automática). Los reveals solo viven acá (como mucho 1 carta con Puzzle).",
        marketTiers: "Tiers de mercado",
        addTier: "+ Agregar tier",
        deleteTier: "Borrar tier",
        tierInUse: "Una location del tablero vende de este tier — cambiala primero.",
        addCard: "+ Carta",
        cardName: "Nombre de la carta",
        symbols: "Símbolos de distrito",
        copies: "Copias",
        play: "Play",
        reveal: "Reveal",
        revealNone: "Ninguno",
        revealResources: "Resources",
        revealPuzzle: "Puzzle",
        puzzleWildcards: "Comodín (?)",
        puzzleAddHint: "Click para agregar",
        puzzleEmpty: "Sin requisitos — click en un símbolo para agregar",
        clickToRemove: "Click para quitar",
        marketTier: "Tier del mercado",
        loadDeckSet: "Cargar Mazo Guardado",
        loadDeckSetPlaceholder: "— elegir un mazo —",
        editDeckSet: "Editar Mazo",
        deckSetLoadConfirm: "Hay cambios sin guardar en los mazos de este mod. ¿Cargar este mazo de todas formas? Se perderán los cambios sin guardar.",
        ...
        signet: "Signet",
        loadSignetSet: "Cargar Personajes Guardados",
        loadSignetSetPlaceholder: "— elegir personajes —",
        editSignetSet: "Editar Personajes",
        signetSetLoadConfirm: "Hay cambios sin guardar en los personajes de este mod. ¿Cargar este set de todas formas? Se perderán los cambios sin guardar.",
        cost: "Coste",
        reward: "Recompensa",
        addEntry: "+ Agregar",
        apply: "Aplicar",
        cancel: "Cancelar",
        discardUnsaved: "Hay cambios sin guardar. ¿Salir igual?",
    },
    characterModal: {
    ...
    game: {
        ...
        fightDistrictTitle: "¿Dónde va el Fight!?",
        fightNoAgents: "Sin agentes en el tablero — el Fight! no se aplica",
        puzzleResolve: "Resolver Puzzle",
        puzzleComplete: "Puzzle completo (+1 VP al revelar)",
        puzzleIncomplete: "Elegí cartas para completar el desafío",
...
const en: Messages = {
    ...
    lobby: {
        ...
        humanSeat: "Human",
        botSeat: "Bot",
        openSeat: "Open seat — joins from the lobby",
        addSeat: "Add seat",
        mixedUnsupported: "Humans + bots in the same match: coming soon",
    ...
    decklab: {
        title: "Decks",
        newDeckSet: "+ New Deck Set",
        empty: "No saved deck sets yet — create the first one",
        unavailable: "No database configured (DATABASE_URL) — deck sets can't be saved",
    },
    signetlab: {
        title: "Signets",
        newSignetSet: "+ New Signet Set",
        empty: "No saved signet sets yet — create the first one",
        unavailable: "No database configured (DATABASE_URL) — signet sets can't be saved",
    },
    modlab: {
        title: "Mod Lab",
        newMod: "+ New Mod",
        empty: "No mods yet — create the first one",
        unavailable: "No database configured (DATABASE_URL) — mods can't be saved",
        edit: "Edit",
        duplicate: "Duplicate",
        delete: "Delete",
        confirmDelete: "Delete this mod forever?",
        back: "Back",
        save: "Save",
        unsaved: "UNSAVED",
        saved: "Saved",
        ...
        updated: "Updated",
        loadDialogTitle: "Load cartridge",
        baseCartridge: "Base (built-in)",
        loaded: "LOADED",
        load: "Load",
        locationName: "Location name",
        restrictedArea: "Restricted area",
        restrictedAreaUnsupported: "Not supported in mods yet",
        notSupportedYet: "coming soon",
        disabledLocation: "Disabled (red strike-through)",
        viewBoard: "Board",
        viewDecks: "Decks",
        viewCharacters: "Characters",
        baseDeck: "Base deck",
        baseDeckHint: "Every player's starting deck (+ their automatic Signet card). Reveals live only here (at most 1 Puzzle card).",
        marketTiers: "Market tiers",
        addTier: "+ Add tier",
        deleteTier: "Delete tier",
        tierInUse: "A board location sells from this tier — change it first.",
        addCard: "+ Card",
        cardName: "Card name",
        symbols: "District symbols",
        copies: "Copies",
        play: "Play",
        reveal: "Reveal",
        revealNone: "None",
        revealResources: "Resources",
        revealPuzzle: "Puzzle",
        puzzleWildcards: "Wildcard (?)",
        puzzleAddHint: "Click to add",
        puzzleEmpty: "No requirements yet — click a symbol to add one",
        clickToRemove: "Click to remove",
        marketTier: "Market tier",
        loadDeckSet: "Load Saved Deck Set",
        loadDeckSetPlaceholder: "— choose a deck set —",
        editDeckSet: "Edit Deck Set",
        deckSetLoadConfirm: "There are unsaved changes to this mod's decks. Load this deck set anyway? Unsaved changes will be lost.",
        ...
        signet: "Signet",
        loadSignetSet: "Load Saved Signet Set",
        loadSignetSetPlaceholder: "— choose a signet set —",
        editSignetSet: "Edit Characters",
        signetSetLoadConfirm: "There are unsaved changes to this mod's characters. Load this signet set anyway? Unsaved changes will be lost.",
        cost: "Cost",
        reward: "Reward",
        addEntry: "+ Add",
        apply: "Apply",
        cancel: "Cancel",
        discardUnsaved: "There are unsaved changes. Leave anyway?",
    },
    characterModal: {
    ...
    game: {
        ...
        fightDistrictTitle: "Where does the Fight! go?",
        fightNoAgents: "No agents on the board — the Fight! fizzles",
        puzzleResolve: "Solve the Puzzle",
        puzzleComplete: "Puzzle complete (+1 VP on reveal)",
        puzzleIncomplete: "Pick cards to complete the challenge",
