...
const es: Messages = {
    ...
    modlab: {
        ...
        viewDecks: "Mazos",
        baseDeck: "Mazo base",
        baseDeckHint: "El mazo inicial de cada jugador (+ su carta Signet automática). Solo acá viven los reveals: 1 de cada tipo.",
...
const en: Messages = {
    ...
    modlab: {
        ...
        viewDecks: "Decks",
        baseDeck: "Base deck",
        baseDeckHint: "Every player's starting deck (+ their automatic Signet card). Reveals live only here: 1 of each type.",
